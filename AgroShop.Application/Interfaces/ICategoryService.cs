...
namespace AgroShop.Application.Interfaces
{
    public interface ICategoryService
    {
        ...
        Task<Result<object?, Error>> AddAsync(AddCategoryDto categoryDto, CancellationToken cancellationToken);
        Task<Result<Category, Error>> UpdateAsync(string id, UpdateCategoryDto categoryDto, CancellationToken cancellationToken);
        Task<Result<object?, Error>> DeleteAsync(string id, CancellationToken cancellationToken);
    }
}
